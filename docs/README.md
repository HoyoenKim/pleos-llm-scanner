...
본 디렉토리는 5 개 문서로 단순화. **[01_report.md](01_report.md)** 가 진입점이고, 나머지 4 개는 보고서가 인용하는 보충 자료.

| 순서 | 파일 | 무엇 |
|---|---|---|
| 1 | [01_report.md](01_report.md) | **★ 통합 보고서 v1.0** — 본 학기 연구 전체. Notation & Glossary + 8장 + Appendix. 외부 reader 가 처음 읽는 곳. |
...
| 5 | [05_future_work.md](05_future_work.md) | 학기 외부 후속 작업 17 종 (4 카테고리: RQ 외부 의존 / 산업 적용 / 학기 발표 / 후속 연구). 본 학기 한계의 정량 해소 경로. |
