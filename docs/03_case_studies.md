...
재현 가능한 evidence path를 포함한다. (finding ID 정의는 [`01_final_report.md`](01_final_report.md) 의 Notation 섹션 참조)
...
`data/_local/decompiled/<apk>/sources/<class>` 의 line으로 추적 가능. 외부 corpus
(UnCrackable Level1)는 `data/_local/apks/_mastg/owasp-mastg/Samples/Android/.../` 경로.
