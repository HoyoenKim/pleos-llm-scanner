...
- **Date**: 2026-04-30
- **Source**: `data/apks/_mastg/owasp-mastg/Crackmes/Android/Level_01/UnCrackable-Level1.apk` (68 KB)
...
- JSON: `data/reports/UnCrackable-Level1_20260430.json`
- Markdown (this file): `data/reports/UnCrackable-Level1_20260430.md`

## Next: ground-truth labelling

`data/ground_truth/mastg/uncrackable_level1.labels.json` 작성 — MASVS official answer 기반 라벨 (in-scope findings 한정). 라벨 후 `src/eval.py` + `src/ablation.py`에 merge.
