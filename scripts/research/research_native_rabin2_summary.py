...
Input:
  data/_local/native_extracts/deep_dive/manifest.json

Outputs:
  data/reports/native_local/native_rabin2_summary.json
  data/reports/native_local/native_rabin2_summary.md
"""
...
RABIN2 = ROOT / "data" / "_local" / "tools" / "r2" / "radare2-6.1.4-w64" / "bin" / "rabin2.exe"
MANIFEST = ROOT / "data" / "_local" / "native_extracts" / "deep_dive" / "manifest.json"
REPORTS = ROOT / "data" / "reports"
OUT_JSON = REPORTS / "native_local" / "native_rabin2_summary.json"
OUT_MD = REPORTS / "native_local" / "native_rabin2_summary.md"
