...
Outputs:
  data/reports/aggregate/native_lib_inventory.md
  data/reports/aggregate/native_lib_inventory.json
"""
...
def main() -> None:
    ...
    print("wrote: data/reports/aggregate/native_lib_inventory.{md,json}")
