...
Outputs:
  data/reports/aggregate/stage_transitions.md
  data/reports/aggregate/stage_transitions.json
"""
...
S3 = ROOT / "data" / "reports" / "local" / "stage3_ensemble.json"
...
def main() -> None:
    ...
    print("wrote: data/reports/aggregate/stage_transitions.{md,json}")
