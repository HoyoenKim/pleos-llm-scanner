...
Outputs:
  data/reports/local/codex_multimodel/sample19_inputs.json
  data/reports/local/codex_multimodel/sample19_model_inputs.json
  data/reports/local/codex_multimodel/full47_inputs.json
  data/reports/local/codex_multimodel/full47_model_inputs.json
...
OUT_DIR = REPORTS / "local" / "codex_multimodel"
STAGE3 = REPORTS / "local" / "stage3_ensemble.json"
GT = ROOT / "data" / "ground_truth" / "combined_labels.json"
AGREEMENT_JSON = REPORTS / "aggregate" / "codex_multimodel_agreement.json"
AGREEMENT_MD = REPORTS / "aggregate" / "codex_multimodel_agreement.md"
...
def build_input_payload(scope: str, ids: list[str], *, include_gt: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "source_files": {
            "claude_baseline": "data/reports/local/stage3_ensemble.json",
