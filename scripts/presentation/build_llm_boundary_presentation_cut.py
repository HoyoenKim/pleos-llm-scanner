...
DEFAULT_DIR = ROOT / "data" / "_local" / "runtime_videos" / "runtime_poc_llm_boundary_demo"
SOURCE_PROMPTS = ROOT / "data" / "_local" / "decompiled" / "ai.pleos.llm.model.provider" / "resources" / "assets" / "prompts.json"
