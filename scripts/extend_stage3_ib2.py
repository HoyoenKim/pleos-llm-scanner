"""Extend data/reports/stage3_ensemble.json with InsecureBankv2 9 findings.
...
P = ROOT / "data" / "reports" / "stage3_ensemble.json"
...
NEW = [
    {
        ...
        "evidence": "<redacted: external public corpus — see data/reports/InsecureBankv2_20260507.json>",
...
def main() -> None:
    ...
    d["input_findings"] = (
        "data/reports/{ai.umos.vehiclecontrol,ai.pleos.sync.syslog,"
        "ai.pleos.llm.model.provider,UnCrackable-Level1,UnCrackable-Level3,"
        "InsecureBankv2}_*.json (n=28 stage1 findings)"
    )
