...
Outputs:
  data/reports/compromise_scenarios_20260514.json
  data/reports/compromise_scenarios_20260514.md
"""
...
STAGE3_PATH = REPORTS_DIR / "stage3_ensemble.json"
NATIVE_FINDINGS_PATH = REPORTS_DIR / "native_deep_dive_findings.json"
OUT_JSON = REPORTS_DIR / "compromise_scenarios_20260514.json"
OUT_MD = REPORTS_DIR / "compromise_scenarios_20260514.md"
...
- Inputs:
  ...
  - `data/reports/stage3_ensemble.json`
  - `data/reports/native_deep_dive_findings.json`
