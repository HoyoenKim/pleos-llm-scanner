...
Outputs:
  data/reports/perspective_agreement_calibrated.md
  data/reports/perspective_agreement_calibrated.json
"""
...
def main() -> None:
    ...
    print(f"wrote: data/reports/perspective_agreement_calibrated.{{md,json}}")
